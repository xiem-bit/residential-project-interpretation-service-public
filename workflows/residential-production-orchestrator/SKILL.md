...
Produce the residential business judgment chain from raw inputs. Treat PPTX, XMind and web prototypes as downstream adapters. Never use visual quality as evidence that the competition strategy was discovered.
...
9. If Product 3 is enabled, derive Chapter 2 from customer choice to value anchor, then map every SC in Chapter 3 to customer gain, project facts, competitive relation, purchase task, UE scenes and system modules. Produce the UE handoff.
