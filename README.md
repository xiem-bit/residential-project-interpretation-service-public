...
本版 `v0.2.0-rc.6` 将产物1—3新版要求接入实际规则、模板、图库和默认生成入口。产物1、2可独立交付；产物3按页面职责形成甲方方案，保留已认可的全屏地图、两侧卡片和大图版位。当前公开图库为201项，人工退出项不再进入生产。产物4只作内部衔接，产物5保持当前能力；Grist不属于依赖。旧20页PPT及三份授权原稿保留历史参考身份，当前默认实现见[代表页](examples/default-production-pages/README.md)。发行状态和边界见[发行说明](RELEASE_STATUS.md)。
