...
公开预发行版 `v0.2.0-rc.1` 已完成P0能力同构冻结，并已补入现行生产约束、增量检索、业务Harness、两套不同机制的完整公开安全项目、真人修订反馈以及产物1、2、3、5的黄金参考。产物3以用户验收的20页授权真实终稿为最高权威，并完整携带三份获授权历史成功原稿、124文件页面模板库、229文件案例素材库、营销文案库、中文报告编辑与断言写作能力；本轮资产扩容后的干净克隆与全包安装验收已经通过。产物4因即将进行上游大修，不进入本次公开发行范围，也没有可安装入口。历史标签 `v0.1.0-rc.1` 保持不可变，并继续定位为“已冻结语义核的下游合同与平台适配演示”。请先读取 [发行状态](RELEASE_STATUS.md) 和 [能力同构合同](CAPABILITY_PARITY_CONTRACT.md)。
